...
-- Additional indentation settings for better language support
vim.opt.indentexpr = ""     -- Use built-in indentation
vim.opt.cinkeys:append('0{,0},0),0],:,0#,!^F,o,O,e')  -- Keys that trigger reindenting in insert mode
vim.opt.cinoptions = vim.opt.cinoptions + "g0,+2s,h2s"  -- Adjust C-style indentation rules
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      ignore = {
        mode = { 'v' } -- Disable which-key in visual mode entirely
      },
    },
  },
  ...
  { -- Autocompletion
    ...
    config = function()
      -- Removing this entire block as it's now handled in lua/custom/plugins/completion.lua
    end,
  },
